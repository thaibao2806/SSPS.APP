...
UpdateNoteResponseModel updateNoteResponseJson (String str) => 
  UpdateNoteResponseModel.fromJson(json.decode(str));
...
class UpdateNoteResponseModel {
  ...
  UpdateNoteResponseModel.fromJson(Map<String, dynamic> json){
    result = json['result'];

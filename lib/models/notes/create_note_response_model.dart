...
CreateNoteResponseModel createNoteResponseJson (String str) => 
  CreateNoteResponseModel.fromJson(json.decode(str));
...
class CreateNoteResponseModel {
  ...
  CreateNoteResponseModel.fromJson(Map<String, dynamic> json){
    result = json['result'];

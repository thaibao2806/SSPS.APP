...
class UsageMoneys {
  ...
  UsageMoneys.fromJson(Map<String, dynamic> json) {
    ...
    priority = json['priority'] ?? 0; // Set a default value for priority if it is null
  }
...
class PaginationResult {
  ...
  PaginationResult.fromJson(Map<String, dynamic> json) {
    ...
    pageSize = json['pageSize'] ?? 0; // Set a default value for pageSize if it is null
    total = json['total'] ?? 0; // Set a default value for total if it is null
   totalPage = json['totalPage'] ?? 0; // Set a default value for totalPage if it is null
  }

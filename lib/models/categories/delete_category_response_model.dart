...
DeleteCategoryResponseModel deleteCategoryResponseJson(String str) =>
    DeleteCategoryResponseModel.fromJson(json.decode(str));
...
class DeleteCategoryResponseModel {
  ...
  DeleteCategoryResponseModel.fromJson(Map<String, dynamic> json){
    result = json['result'];
